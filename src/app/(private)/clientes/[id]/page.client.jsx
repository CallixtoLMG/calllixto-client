...
const CustomerPageClient = ({ customer }) => {
      ...
      const actions = [
        {
          ...
          text: isItemInactive(customer.state) ? "Activar cliente" : "Desactivar cliente",
        ...
        },
        {
          ...
          collapsedTooltip: customer.hasBudgets ? "No se puede eliminar este cliente, existen presupuestos asociados." : undefined,
          basic: true,
