    ...
    if (product) {
      ...
      if (!isProductDeleted(product?.state) && !isProductInactive(product?.state)) {
        actions.push({
          ...
          text: isProductOOS(product?.state) ? "Actualizar a con stock" : "Actualizar a sin stock",
          showTooltipWhenExpanded: true,
      ...
      if (!isProductDeleted(product?.state)) {
        actions.push({
          ...
          text: isProductInactive(product?.state) ? "Activar producto" : "Desactivar producto",
